    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-2xl font-bold text-brand-navy">Sign in coming soon</h1>
          <p className="text-neutral-500 text-sm mt-2 mb-8">
            Authentication is on the way. In the meantime, you can explore the dashboard right now.
          </p>
